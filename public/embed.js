...
(function () {
  ...
  function ensureOverlayStyles() {
    ...
    injectStyles([
      ...
      ".hc-embed-overlay.hc-panel{top:0;right:0;bottom:0;left:auto;width:clamp(400px,40vw,560px);height:100vh;height:100dvh;max-width:none;max-height:none;border-radius:0;transform:translateX(100%);box-shadow:-24px 0 60px rgba(0,0,0,.28);transition:transform .42s cubic-bezier(.16,1,.3,1),opacity .3s ease}",

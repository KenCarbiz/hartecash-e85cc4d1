        ...
        <Card>
          <CardHeader className="pb-3">
            <CardTitle className="text-base flex items-center gap-2">
              ...
              {pricingModel.row && (
                <span
                  className="ml-2 inline-flex items-center gap-1 rounded-full border border-success/30 bg-success/10 px-2 py-0.5 text-micro font-semibold uppercase tracking-wider text-success dark:text-emerald-300"

// Legacy Appraiser Queue — preserved verbatim behind the ui_refresh
// kill switch (see src/hooks/useUIRefresh.ts). When
// site_config.ui_refresh_enabled = false (the default), AppraiserQueue.tsx
// delegates to this component so the experience is byte-for-byte
// identical to what dealers see today.
//
// Do not edit this file as part of the UI refresh. If you need to fix a
// bug in the legacy queue, fix it here AND in the refreshed body inside
// AppraiserQueue.tsx.
...
const LegacyAppraiserQueue = ({ userRole = "", isAppraiser = false }: AppraiserQueueProps) => {
...
export { LegacyAppraiserQueue };
export type { AppraiserQueueProps };

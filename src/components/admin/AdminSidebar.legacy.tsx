// Legacy admin sidebar — preserved verbatim behind the ui_refresh
// kill switch (see src/hooks/useUIRefresh.ts). When
// site_config.ui_refresh_enabled = false (the default), AdminSidebar.tsx
...
// bug in the legacy sidebar, fix it here AND in the refreshed version

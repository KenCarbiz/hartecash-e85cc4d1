// Legacy Appointment Manager — preserved verbatim behind the ui_refresh
// kill switch (see src/hooks/useUIRefresh.ts). When
// site_config.ui_refresh_enabled = false (the default),
// AppointmentManager.tsx delegates to this component so the experience
// is byte-for-byte identical to what dealers see today.
//
// Do not edit this file as part of the UI refresh. If you need to fix a
// bug in the legacy view, fix it here AND in the refreshed body inside
...
const LegacyAppointmentManager = ({
  appointments,
  setAppointments,
  submissions,
  dealerLocations,
...
export { LegacyAppointmentManager };
export type { AppointmentManagerProps };

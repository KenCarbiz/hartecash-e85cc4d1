...
const PrimaryCTA = ({ children, showArrow = true, className, ...rest }: Props) => (
  <button
    {...rest}
    className={cn(
      "inline-flex w-full items-center justify-center gap-2 rounded-xl bg-[hsl(262_83%_58%)] px-6 py-3.5 text-base font-medium text-white shadow-[0_1px_2px_rgba(0,0,0,0.08)] transition-all hover:bg-[hsl(262_83%_52%)] hover:shadow-md active:scale-[0.99] disabled:cursor-not-allowed disabled:bg-zinc-200 disabled:text-zinc-400 disabled:shadow-none sm:w-auto sm:min-w-[200px]",
      className,
    )}
  >
    {children}

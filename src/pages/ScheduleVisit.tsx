            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="p-3.5 bg-muted/30 border border-border rounded-xl">
                <p className="text-[11px] text-muted-foreground leading-relaxed">
                  By submitting, you consent to receive autodialed calls, texts (SMS/MMS), and emails from {config.dealership_name || "Our Dealership"} at the number and email provided regarding your appointment and vehicle. Consent is not a condition of purchase. Msg & data rates may apply. Msg frequency varies. Reply STOP to opt out. See our{" "}

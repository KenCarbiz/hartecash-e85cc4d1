...
import PlatformBillingV2 from "@/components/admin/v2/PlatformBillingV2";
...
const AdminDashboardV2 = () => {
  ...
  const onPlatformBilling = baseSectionId === "platform-billing";
  const onV2Custom = onCommandCenter || onAnalytics || onAvailability || onMyBusiness || onLaneDashboard || onReleaseCenter || onDealerNetwork || onServiceDrive || onWebsiteWidget || onVehicleCheckIn || onAppointments || onStoreSettings || onReEngagement || onAllLeads || onAppraiserQueue || onBdcQueue || onPerformance || onReports || onMarketing || onIntegrations || onGroups || onExport || onStaff || onProspectDemo || onStripeWebhooks || onSystemSettings || onImageCache || onRooftopWebsites || onWebsiteEmbed || onAuditLog || onLocations || onSaasPricing || onPlatformBilling;

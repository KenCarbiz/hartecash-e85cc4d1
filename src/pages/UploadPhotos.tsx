  ...
  useEffect(() => {
    const fetchSubmission = async () => {
      ...
      if (err || !data || data.length === 0) {
        // Empty result is ambiguous: token might be expired, missing,
        // or the request errored. Disambiguate so we can show the
        // right recovery CTA (re-request a fresh link vs. lookup).

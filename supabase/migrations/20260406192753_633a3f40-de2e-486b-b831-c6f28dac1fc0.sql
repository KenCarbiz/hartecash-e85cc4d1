ALTER TABLE public.site_config ADD COLUMN IF NOT EXISTS about_image_urls text[] NOT NULL DEFAULT '{}';
ALTER TABLE public.dealership_locations ADD COLUMN IF NOT EXISTS about_image_urls text[] NOT NULL DEFAULT '{}';

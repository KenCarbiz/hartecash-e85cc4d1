-- Tighten phone matching in lookup_submission_by_contact.
--
-- The previous version only stripped dashes, spaces, and parentheses.
-- That left these formats as silent zero-matches:
--   "+1 (555) 123-4567"  → "+15551234567"
--   "555.123.4567"       → "555.123.4567"
--   "1-555-123-4567"     → "15551234567"
-- ...while the stored phone might be plain "5551234567".
--
-- New behaviour: normalize both sides by stripping every non-digit, then
-- drop a leading "1" if the result is 11 digits (US country code). This
-- makes the lookup tolerant of any punctuation a returning customer types.
--

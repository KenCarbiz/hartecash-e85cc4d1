...
DROP VIEW IF EXISTS public.v_dealership_mfa_status;
CREATE VIEW public.v_dealership_mfa_status AS
SELECT
  ur.dealership_id,
...
BEGIN
  ...
  SELECT ur.dealership_id, ur.role::text, 0
...
BEGIN
  ...
  SELECT dealership_id, NULL::text
    INTO _dealer, _label
